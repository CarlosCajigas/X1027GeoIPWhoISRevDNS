...
V3.4 - 2019-01-21 Added the ability to do host resolution and chaged the CLI flags
V3.5 - Bug found where GEOIPCO was None, fixed 
"""
...
#give it to the tool via the -if flag.
	print "IP = " + holder[0]
	print "GEOIPCO = " + str(holder[1])
	print "GEOIPCOUNTRY = " + str(holder[2])
	print "REVERSEDNS = " + holder[3]
	print "OKorNotIGEOIPdb = " + holder[4]
	print "WhoIsCOUNTRY = " + str(holder[5])
	print "WhoIsDESCRIPTION = " + str(holder[6])
